...
local validStanceTable = WoW10 and {
	...
	[3] = (L["Page %2d (%s)"]):format(3, (L["Bar %s"]):format("4")),
	[4] = (L["Page %2d (%s)"]):format(4, (L["Bar %s"]):format("5")),
	[5] = (L["Page %2d (%s)"]):format(5, (L["Bar %s"]):format("3")),
	[6] = (L["Page %2d (%s)"]):format(6, (L["Bar %s"]):format("2")),
	[7] = (L["Page %2d (%s)"]):format(7, (L["Class Bar %d"]):format(1)),
	[8] = (L["Page %2d (%s)"]):format(8, (L["Class Bar %d"]):format(2)),
	[9] = (L["Page %2d (%s)"]):format(9, (L["Class Bar %d"]):format(3)),
	[10] = (L["Page %2d (%s)"]):format(10, (L["Class Bar %d"]):format(4)),
	[13] = (L["Page %2d (%s)"]):format(13, (L["Bar %s"]):format("6")),
	[14] = (L["Page %2d (%s)"]):format(14, (L["Bar %s"]):format("7")),
	[15] = (L["Page %2d (%s)"]):format(15, (L["Bar %s"]):format("8")),
} or {
	[0] = L["Don't Page"],
	(L["Page %2d"]):format(1),
	(L["Page %2d"]):format(2),
